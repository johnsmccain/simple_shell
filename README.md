...
```c
git clone https://github.com/johnsmccain/simple_shell.git
```

- SSH:

```
git clone git@github.com:johnsmccain/simple_shell.git
```
...
- *Caleb Aregbesola*  - [@cvbanns](https://github.com/cvbanns)
